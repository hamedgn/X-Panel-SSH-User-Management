...
## توجه <br>
اگر از نسخه 3.6 یا نسخه های پائین تر استفاده میکنید. از دیتابیس خود بکاپ بگیرید در یک سرور جدید نسخه جدید XPanel را نصب کنید سپس دیتابیس را از بخش Backup قسمت Import Only Users  درون ریزی نمائید.
در نسخه جدید که با فرمورک لاراول می باشد  دیتابیس به کل تغییر کرده است.
